...
Launcher::DataFilesPage::DataFilesPage(Files::ConfigurationManager &cfg, Config::GameSettings &gameSettings,
    ...
    , mNavMeshToolInvoker(new Process::ProcessInvoker())
{
    ui.setupUi (this);
...
void Launcher::DataFilesPage::buildView()
{
    ...
    connect(ui.cancelNavMeshButton, SIGNAL(clicked()), this, SLOT(terminateNavMeshTool()));
...
void Launcher::DataFilesPage::terminateNavMeshTool()
{
    mNavMeshToolInvoker->terminateProcess();
}
