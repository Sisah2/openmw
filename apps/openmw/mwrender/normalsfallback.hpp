...
namespace MWRender
{
    ...
    {
        NormalsMode_MRT = 0,
        NormalsMode_Camera = 1,
        NormalsMode_PackedTextureRerender = 2,
        NormalsMode_PackedTextureFetch = 3,
        NormalsMode_PackedTextureFetchOnly = 4
    };
    ...
    public:
        ...
        osg::ref_ptr<osg::Geometry> getGeometry(int i) { return mNormalsFallbackGeometries[i]; }

        osg::ref_ptr<CopyTextureCallback> getCopyTextureCallback(int i) { return mCopyTextureCallbacks[i]; }
