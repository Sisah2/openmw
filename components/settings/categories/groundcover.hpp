...
namespace Settings
{
    struct GroundcoverCategory : WithIndex
    {
        ...
        SettingValue<bool> mAutoLoad{ mIndex, "Groundcover", "auto load" };
        SettingValue<float> mMinChunkSize{ mIndex, "Groundcover", "min chunk size", makeClampSanitizerFloat(0.125, 1) };
